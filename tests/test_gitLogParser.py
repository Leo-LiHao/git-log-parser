...
def test_dummy_commit_singleDir():
    ...
    parser.get_log(args)
    with open('./gitlogparser/tests/correct_result.json', 'r', encoding='utf-8') as f:
        with open('./gitlogparser/tests/logdata_new.json', 'r', encoding='utf-8') as f2:
...
def test_dummmy_commit_mDir():
    ...
    parser.get_log(args)
    with open('./gitlogparser/tests/correct_result.json', 'r', encoding='utf-8') as f:
        with open('./gitlogparser/tests/logdata_.git.json', 'r', encoding='utf-8') as f2:
            correct_result = json.load(f)
            current_result = json.load(f2)
            assert correct_result == current_result